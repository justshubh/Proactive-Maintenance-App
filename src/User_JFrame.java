...
document.addSubject("hhhhhhhhhhhh");     
 ...
 document.add(new Paragraph((new Chunk("CRIS                                         "   + day + "/" + (month + 1) + "/" + year, FontFactory.getFont(FontFactory.HELVETICA, 18, Font.BOLD)))));
 document.add(new Paragraph("CENTRE FOR RAILWAY INFORMATION SYSTEMS (CRIS)"));
 document.add(new Paragraph("*************************************************************************************************"));
PdfPTable table=new PdfPTable(2);
PdfPCell cell = new PdfPCell (new Paragraph ("CRIS REPORT"));
cell.setColspan (8);
...
PdfPCell cell1 = new PdfPCell (new Paragraph ("CRIS MIN-MAX-AVG REPORT"));
cell1.setColspan (8);
...
document.add(table1);
    ...
    document.add(new Paragraph(""));   
document.add(new Paragraph("© 2016-2017 CRIS. All right reserved."));
...
try{
 ...
 System.exit(0);
    ...
    private void cmd_report1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_report1ActionPerformed
        ...
        try{
         String report="D:\\NetbeansProject\\Source code PROMA\\Proma2.jrxml";
